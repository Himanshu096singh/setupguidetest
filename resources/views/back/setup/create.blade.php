      ...
      <div class="row justify-content-center">
         <div class="white_card card_height_100 mb_30">
            <div class="white_card_header white_box_tittle pink_bg">
               <div class="box_header m-0">
                  <div class="main-title">
                     <h3 class="m-0 text_white">How To Setup </h3>
            ...
            <div class="white_card_body">
                ...
                <hr>
               <div class="card-body">
                  <form method="post" action="{{route('admin.setup.store')}}" enctype='multipart/form-data'> 
                    @csrf
                     <div class="row mb-3">
                        <div class="col-md-6">
                           <label class="form-label" for="title">Product Setup Title</label>
                           <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="Name" value="{{old('title')}}" placeholder="Setup Title">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control summernote" rows="3" name="prerequisite" id="prerequisite" placeholder="Prerequisite">{{old('prerequisite')}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control summernote" rows="3" name="windows" id="windows" placeholder="windows">{{old('windows')}}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="mac">Mac</label>
                            <textarea class="form-control summernote" rows="3" name="mac" id="mac" placeholder="mac">{{old('mac')}}</textarea>
                        </div>
                    </div>
